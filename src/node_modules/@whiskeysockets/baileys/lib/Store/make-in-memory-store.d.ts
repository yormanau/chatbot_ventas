...
import type makeMDSocket from '@whiskeysockets/baileys/lib/Socket';
import type { BaileysEventEmitter, Chat, ConnectionState, Contact, GroupMetadata, PresenceData, WAMessage, WAMessageCursor, WAMessageKey } from '@whiskeysockets/baileys/lib/Types';
