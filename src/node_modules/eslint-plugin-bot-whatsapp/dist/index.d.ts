...
declare const rules: {
    'func-prefix-goto-flow-return': {
        ...
        create: (context: import("eslint-plugin-bot-whatsapp/src/types").Context) => {
            'CallExpression[callee.name="gotoFlow"]'(node: import("eslint-plugin-bot-whatsapp/src/types").INode): void;
        };
    };
    'func-prefix-fall-back-return': {
        ...
        create: (context: import("eslint-plugin-bot-whatsapp/src/types").Context) => {
            'CallExpression[callee.name="fallBack"]'(node: import("eslint-plugin-bot-whatsapp/src/types").INode): void;
        };
    };
    'func-prefix-end-flow-return': {
        ...
        create: (context: import("eslint-plugin-bot-whatsapp/src/types").Context) => {
            'CallExpression[callee.name="endFlow"]'(node: import("eslint-plugin-bot-whatsapp/src/types").INode): void;
        };
    };
    'func-prefix-dynamic-flow-await': {
        ...
        create: (context: import("eslint-plugin-bot-whatsapp/src/types").Context) => {
            'CallExpression[callee.name="flowDynamic"]'(node: import("eslint-plugin-bot-whatsapp/src/types").INode): void;
        };
    };
